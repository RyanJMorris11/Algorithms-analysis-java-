...
public class OldKnapSack {
	...
	static long elapsed;
	static KnapsackSolution DPSoln;
	...
	public static void main(String[] args) {
		...
		CustomSolver1 bf = new CustomSolver1();
